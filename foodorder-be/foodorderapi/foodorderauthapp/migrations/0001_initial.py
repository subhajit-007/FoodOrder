    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('restaurantowner', 'RestaurantOwner'), ('customer', 'Customer')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(default='', max_length=10)),
                ('address', models.CharField(default='', max_length=500)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='book_owner_account', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
